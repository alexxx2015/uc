...
import de.tum.in.i22.uc.blocks.codeblockutil.Sound;
import de.tum.in.i22.uc.blocks.codeblockutil.SoundManager;
...
public class BlockLink {
     ...
     */
    public void connect() {
       connectProperly(true);
    }
    
    //09 March 2013. My version of connect to prevent cyclic behaviour
    public void connectProperly(boolean fireEvent){
