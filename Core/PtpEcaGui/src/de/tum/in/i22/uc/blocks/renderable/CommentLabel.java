...
public class CommentLabel extends BlockControlLabel {
    ...
    public void mouseClicked(MouseEvent e) {    	
        ...
        workspace.notifyListeners(new WorkspaceEvent(workspace, rb.getComment().getCommentSource().getParentWidget(), WorkspaceEvent.BLOCK_COMMENT_VISIBILITY_CHANGE,ps));
        update();
        rb.revalidate();
        rb.repaint();
