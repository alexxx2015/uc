...
public class WorkspaceEvent {
    ...
    public final static int BLOCK_COMMENT_VISIBILITY_CHANGE = 17;
    public final static int BLOCK_COMMENT_CHANGED = 18;
    //Block param events
    public final static int BLOCK_PARAM_ADDED = 19;
    public final static int BLOCK_PARAM_REMOVED = 20;
    public final static int BLOCK_PARAM_MOVED = 21;
    public final static int BLOCK_PARAM_RESIZED= 22;
    public final static int BLOCK_PARAM_VISIBILITY_CHANGE = 23;
    public final static int BLOCK_PARAM_CHANGED= 24;
    /**
     * 27 April 2013
     * My addition to simplify paramater change events
     */
    public final static int BLOCK_PARAM_POLICYTYPE_CHANGED= 25;
    /**
     * 30 April 2013
     * My addition to simplify paramater change events
     */
    public final static int BLOCK_PARAM_STATUS_CHANGED=26;
    public final static int BLOCK_PARAM_CLASS_CHANGED=27;
    public final static int BLOCK_PARAM_VALUE_CHANGED=28;    
    ...
    /**
     * My addition. This will help for undo and redo as it will be casted to
     * the target specific object and used
     */        
    ...
    /**
     * My addition. 03 March 2013. For block comment events
     * 
     * @param workspace
     * @param page
     * @param eventType
     * @param previousState
     */
    public WorkspaceEvent(Workspace workspace, WorkspaceWidget page, int eventType, PreviousState previousState) {
        this(workspace,page,eventType);    	
        oPreviousState=previousState;
    }
     ...
     * @param previousState
     */
    public WorkspaceEvent(Workspace workspace, WorkspaceWidget widget, Long blockID, int eventType, PreviousState previousState) {
    	this(workspace,widget,blockID,eventType);
    	oPreviousState=previousState;         
    }
     ...
     * @param previousState
     */
    public WorkspaceEvent(Workspace workspace, WorkspaceWidget widget, Long blockID, int eventType, boolean userSpawned, PreviousState previousState){
    	this(workspace,widget,blockID,eventType,userSpawned);
    	oPreviousState=previousState;
    }
     ...
     * 24 February 2013
     * 
     * Return the previous state of an object concerned
     */
