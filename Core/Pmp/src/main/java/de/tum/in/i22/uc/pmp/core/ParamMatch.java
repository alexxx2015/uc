...
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.DataInContainerComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.ElementInListComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.EndsWithComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.EqualsComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.EqualsIgnoreCaseComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.GeComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.GenericComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.GtComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.LeComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.ListInListComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.LtComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.NotEqualsComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.StartsWithComparisonOperator;
import de.tum.in.i22.uc.pmp.core.condition.comparisonOperators.SubstringComparisonOperator;
    ...
    if(this.getName().equals(param.getName()))
    {
      ...
      if (this.getCmpOp()!=null){
		...
		case DATA_IN_CONTAINER:
			IPmp2Pip pip=PmpDecisionPoint.getInstance().get_pip();
			if (pip==null){
