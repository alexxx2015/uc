...
import de.tum.in.i22.uc.pmp.core.shared.IPmpAuthorizationAction;
import de.tum.in.i22.uc.pmp.core.shared.IPmpExecuteAction;
import de.tum.in.i22.uc.pmp.core.shared.Param;
import de.tum.in.i22.uc.pmp.xsd.AuthorizationActionType;
import de.tum.in.i22.uc.pmp.xsd.AuthorizationAllowType;
import de.tum.in.i22.uc.pmp.xsd.AuthorizationInhibitType;
import de.tum.in.i22.uc.pmp.xsd.action.ExecuteActionType;
import de.tum.in.i22.uc.pmp.xsd.action.ParameterType;

public class AuthorizationAction implements Serializable, IPmpAuthorizationAction
{
  ...
  public static final IPmpAuthorizationAction AUTHORIZATION_INHIBIT =new AuthorizationAction("INHIBIT", Constants.AUTHORIZATION_INHIBIT);
  public static final IPmpAuthorizationAction AUTHORIZATION_ALLOW   =new AuthorizationAction("ALLOW", Constants.AUTHORIZATION_ALLOW);

  private boolean                         type                  =false;
  private String                          name                  ="";
  private IPmpAuthorizationAction             fallback              =AUTHORIZATION_INHIBIT;
  private String                          fallbackName          ="";
  private List<IPmpExecuteAction>             executeSyncActions    =new ArrayList<IPmpExecuteAction>();
  ...
  public AuthorizationAction(int start, String name, boolean type, List<IPmpExecuteAction> executeActions, long delay, List<Param<?>> modifiers,
      IPmpAuthorizationAction fallback)
  {
    this.type=type;
  ...
  public List<IPmpExecuteAction> getExecuteActions()
  {
  ...
  public void setExecuteActions(List<IPmpExecuteAction> executeActions)
  {
  ...
  public void addExecuteAction(IPmpExecuteAction executeAction)
  {
  ...
  public IPmpAuthorizationAction getFallback()
  {
    return fallback == null ? AUTHORIZATION_INHIBIT : fallback;
  }

  public void setFallback(IPmpAuthorizationAction fallback)
  {
  ...
  public String toString()
  {
    ...
    for(IPmpExecuteAction a : this.executeSyncActions)
      str+=a.toString() + ", ";
