...
import de.tum.in.i22.uc.pmp.core.condition.Condition;
...
import de.tum.in.i22.uc.pmp.core.shared.IPolicyDecisionPoint;
import de.tum.in.i22.uc.pmp.xsd.AuthorizationActionType;
import de.tum.in.i22.uc.pmp.xsd.MechanismBaseType;
import de.tum.in.i22.uc.pmp.xsd.PreventiveMechanismType;
import de.tum.in.i22.uc.pmp.xsd.action.ExecuteAsyncActionType;

public class Mechanism extends Thread implements IPmpMechanism
{
  ...
  private IPmpAuthorizationAction authorizationAction =null;
  private List<IPmpExecuteAction> executeAsyncActions =new ArrayList<IPmpExecuteAction>();

  private PmpDecisionPoint pmp = null;
  ...
  public Mechanism(MechanismBaseType mech) throws InvalidMechanismException
  {
    ...
    if(mech instanceof PreventiveMechanismType)
    {
      ...
      {
        IPmpAuthorizationAction curAuth = this.authorizationAction;
        ...
        do
        {
          ...
          {
            IPmpAuthorizationAction fallbackAuth =authActions.get(curAuth.getFallbackName());
  ...
  public boolean init(PmpDecisionPoint pmp)
  {
...
public IPmpAuthorizationAction getAuthorizationAction()
  ...
  @Override
public void setAuthorizationAction(IPmpAuthorizationAction authorizationAction)
  {
...
public List<IPmpExecuteAction> getExecuteAsyncActions()
  ...
  public void setExecuteAsyncActions(List<IPmpExecuteAction> executeAsyncActions)
  {
    ...
    while(!isInterrupted())
    {
      try
      {
        ...
        if(mechanismValue)
        {
          ...
          for(IPmpExecuteAction execAction : this.getExecuteAsyncActions())
          {
