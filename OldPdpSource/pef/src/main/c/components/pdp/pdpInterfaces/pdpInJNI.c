 ...
 * package de.fraunhofer.iese.ind2uce.pdp. Otherwise Java will complain about linking problems with the
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved)
{
  ...
  //jclass lclsPDPinstance=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/PolicyDecisionPoint");
  jclass lclsDecision=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/Decision");
  jclass lclsExecuteAction=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/ExecuteAction");
  jclass lclsAuthorizationAction=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/AuthorizationAction");
  jclass lclsEvent=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/Event");
  jclass lclsParameter=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/internal/pdp/Param");
  ...
  if(lclsDecision==NULL || lclsExecuteAction==NULL || lclsAuthorizationAction==NULL ||
  ...
  if(jniDecision.cls==NULL || jniExecuteAction.cls==NULL || jniAuthAction.cls==NULL ||
  ...
  jniDecision.addExecuteAction=(*lenv)->GetMethodID(lenv, jniDecision.cls, "addExecuteAction", "(Lde/fraunhofer/iese/ind2uce/internal/pdp/ExecuteAction;)V");
  jniDecision.setAuthAction=(*lenv)->GetMethodID(lenv, jniDecision.cls, "setAuthorizationAction", "(Lde/fraunhofer/iese/ind2uce/internal/pdp/AuthorizationAction;)V");

  jniExecuteAction.constructor=(*lenv)->GetMethodID(lenv, jniExecuteAction.cls, "<init>", "()V");
  jniExecuteAction.addParameter=(*lenv)->GetMethodID(lenv, jniExecuteAction.cls, "addParameter", "(Lde/fraunhofer/iese/ind2uce/internal/pdp/Param;)V");
  ...
  jniAuthAction.addModifier=(*lenv)->GetMethodID(lenv, jniAuthAction.cls, "addModifier", "(Lde/fraunhofer/iese/ind2uce/internal/pdp/Param;)V");
  ...
  jfieldID responseAllowID=(*lenv)->GetStaticFieldID(lenv, jniDecision.cls, "RESPONSE_ALLOW", "Lde/fraunhofer/iese/ind2uce/internal/pdp/Decision;");
  jobject lresponseAllow=(*lenv)->GetStaticObjectField(lenv, jniDecision.cls, responseAllowID);

  jfieldID responseInhibitID=(*lenv)->GetStaticFieldID(lenv, jniDecision.cls, "RESPONSE_INHIBIT", "Lde/fraunhofer/iese/ind2uce/internal/pdp/Decision;");
  ...
  //jniPDP.getInstance=(*lenv)->GetStaticMethodID(lenv, jniPDP.cls, "getInstance", "()Lde/fraunhofer/iese/ind2uce/internal/pdp/IPolicyDecisionPoint;");
  //jniPDP.getInstance=(*lenv)->GetStaticMethodID(lenv, jniPDP.cls, "getInstance", "()Lde/fraunhofer/iese/ind2uce/internal/pdp/IPolicyDecisionPoint;");
  ...
  // Initializing PIP connection (if set to JNI)
    ...
    //jclass lclsPIPinstance=(*lenv)->FindClass(lenv, "de/fraunhofer/iese/ind2uce/pdp/example/pipExample");
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpStart(JNIEnv *env, jobject jobj)
{
  if(curjvm==NULL)
  {
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpStop(JNIEnv *env, jobject jobj)
{
  return pdp->stop();
}

JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpDeployPolicy(JNIEnv *env, jobject jobj, jstring jPolicyDocPath)
{
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpDeployPolicyString(JNIEnv *env, jobject jobj, jstring jPolicyString)
{
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpDeployMechanism(JNIEnv *env, jobject jobj,
...
JNIEXPORT jstring JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_listDeployedMechanisms(JNIEnv *env, jobject jobj)
{
...
JNIEXPORT jobject JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_listDeployedMechanismsJNI(JNIEnv *env, jobject jobj)
{
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpRevokeMechanism(JNIEnv *env, jobject jobj, jstring jMechanismName, jstring jns)
{
...
JNIEXPORT jstring JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpNotifyEventXML(JNIEnv *env, jobject jobj, jstring jeventDoc)
{
...
JNIEXPORT jobject JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_pdpNotifyEventJNI(JNIEnv *env, jobject jobj, jobject jeventObject)
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_setRuntimeLogLevel(JNIEnv *env, jobject jobj, jint newLevel)
{
  return pefLogSetRTLevel(newLevel);
}

JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_registerPEP
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_registerAction
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_registerPXP
...
JNIEXPORT jint JNICALL Java_de_fraunhofer_iese_ind2uce_pdp_PolicyDecisionPoint_registerExecutor
