...
public class Response implements org.apache.thrift.TBase<Response, Response._Fields>, java.io.Serializable, Cloneable, Comparable<Response> {
  ...
  public int hashCode() {
    ...
    boolean present_executeEvents = true && (isSetExecuteEvents());
    builder.append(present_executeEvents);
    if (present_executeEvents)
      builder.append(executeEvents);

    boolean present_modifiedEvents = true && (isSetModifiedEvents());
    builder.append(present_modifiedEvents);
    if (present_modifiedEvents)
      builder.append(modifiedEvents);
