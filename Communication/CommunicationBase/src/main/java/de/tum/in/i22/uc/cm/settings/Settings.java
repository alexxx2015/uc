...
public class Settings extends SettingsLoader {
	...
	private EDistributedStrategy _distributionStrategy = EDistributedStrategy.PUSH;
	...
	private void loadProperties() {
		...
		_distributionStrategy = loadSetting("pip_distribution_strategy", _distributionStrategy, EDistributedStrategy.class);
	...
	public EDistributedStrategy getDistributionStrategy() {
