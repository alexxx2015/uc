...
import de.tum.in.i22.cm.in.pip.PipRequest;
import de.tum.in.i22.cm.in.pmp.PmpRequest;
import de.tum.in.i22.cm.out.pip.Pdp2PipTcpImp;
...
public class RequestHandler implements Runnable {
	...
	private RequestHandler() {
		...
		_pdp2PipProxy = new Pdp2PipTcpImp(GlobalSettings.getInstance().getPipAddress(), GlobalSettings.getInstance().getPipPortNum());
	...
	public void setPdpHandler(IAny2Pdp pdpHandler) {
