...
public class PdpThriftServerHandler extends ClientConnectionHandler implements
ExtendedThriftConnector.Iface {

	private static final String IP = "localhost";
	private static int PORT = 8090;

	private static final Logger _logger = LoggerFactory.getLogger(PdpThriftServerHandler.class);

	public PdpThriftServerHandler(int pepPort) {
