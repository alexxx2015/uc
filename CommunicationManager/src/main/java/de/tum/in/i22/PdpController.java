...
import de.tum.in.i22.cm.in.pep.PepClientPipeConnectionHandler;
import de.tum.in.i22.cm.in.pep.PepTcpServiceHandler;
import de.tum.in.i22.cm.in.pep.thrift.ThriftServer;
import de.tum.in.i22.cm.in.pip.PipTcpServiceHandler;
import de.tum.in.i22.cm.in.pmp.PmpTcpServiceHandler;
...
public class PdpController {
	 ...
	 */
	@Inject
	public PdpController(IAny2Pdp pdpHandler) {
	...
	public static GlobalSettings getPdpSettings() {
	...
	public static void main(String[] args) {
		...
		try {
			if (cl.hasOption(OPTION_PDP_PROPS)) {
				GlobalSettings.getInstance(cl.getOptionValue(OPTION_PDP_PROPS)).loadProperties();
			}
			else {
