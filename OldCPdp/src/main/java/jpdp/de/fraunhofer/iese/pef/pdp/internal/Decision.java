...
import de.fraunhofer.iese.pef.pdp.internal.xml.DecisionParser;
...
public class Decision implements java.io.Serializable
{
  ...
  public Decision(String responseXml) throws IOException, SAXException
  {
    DecisionParser handler=new DecisionParser(this);
    XMLReader parser=XMLReaderFactory.createXMLReader();
    parser.setContentHandler(handler);
    parser.parse(new InputSource(new StringReader(responseXml)));
  }
