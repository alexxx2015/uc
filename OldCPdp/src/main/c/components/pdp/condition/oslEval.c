...
//  }
  ...
  unsigned int predicateLength=strlen(curOperands->operator) + strlen(curOperands->param1) + 3;

  if(curOperands->param2!=NULL)
    predicateLength+=strlen(curOperands->param2) + 2;
  ...
  if(curOperands->param2!=NULL)
  {
    if(curOperands->param3!=NULL)
    {
      snprintf(predicate, predicateLength, "%s##%s##%s##%s", curOperands->operator, curOperands->param1, curOperands->param2, curOperands->param3);

    }
    else
    {
      snprintf(predicate, predicateLength, "%s##%s##%s", curOperands->operator, curOperands->param1, curOperands->param2);
    }
  }
  else
    snprintf(predicate, predicateLength, "%s##%s", curOperands->operator, curOperands->param1);
