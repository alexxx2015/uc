...
import javax.swing.JComponent;
	...
	/**
	 * Draws an arrow (triangle to make the param look like a speech bubble) between a param and its source.
	 * 
	 * 
	 * @author joshua
	 *
	...
	public class ParamArrow {
	   ...
	   /**
	    * update arrow properties according to current location of param and paramSource
	    */
		public void updateArrow() {
			Container parentContainer = param.getParent();
			
			if(param.getParamSource() != null && parentContainer != null){
				//Point start = SwingUtilities.convertPoint(commentSource, commentSource.getLocation(), parentContainer);
				Point start = (Point) (param.getParamSource().getParamLocation());
				Point end = (Point) (param.getLocation());
				end.translate(param.getWidth()/2,param.getHeight()/2);
		...
		/**
		 * Class in charge of drawing actual triangular arrow between the param and the ParamSource
		 * @author admin
		 *
		 */
		private class Arrow extends JComponent {
			...
			public void paint(Graphics g) {
				...
				g2.addRenderingHints(new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON));
		 		g2.setColor(param.getBorderColor().darker());
				g2.fillPolygon(xpoints, ypoints, 3);
			}

			/**
			 * Set the three x coordinates of the triangle (in the coordinate system containing the param and paramSource)
			 * @param x1
			 * @param x2
			 * @param x3
			 */
			...
			/**
			 * Set the three y coordinates of the triangle (in the coordinate system containing the param and paramSource)
			 * @param y1
			 * @param y2
			 * @param y3
			 */
