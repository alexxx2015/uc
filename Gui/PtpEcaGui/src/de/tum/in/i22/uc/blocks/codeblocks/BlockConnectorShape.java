...
public class BlockConnectorShape {
    ...
    public static final float DATA_PLUG_HEIGHT = 51.0f;

    /** Width of most plug shapes */
    public static final float NORMAL_DATA_PLUG_WIDTH = 17.0f;

    /** Width of polymorphic plug shape */
    public static final float POLYMORPHIC_DATA_PLUG_WIDTH = 17.0f;

    /** width of vertical control connection */
    public static final float CONTROL_PLUG_WIDTH = 30.0f;

    /** height of vertical control connection */
    public static final float CONTROL_PLUG_HEIGHT = 10.0f;

    /** width of command input bar */
    public static final float COMMAND_INPUT_BAR_WIDTH = BlockShape.COMMAND_PORT_OFFSET + 5f;

    /** height of command input bar */
    public static final float COMMAND_INPUT_BAR_HEIGHT = 30f;
