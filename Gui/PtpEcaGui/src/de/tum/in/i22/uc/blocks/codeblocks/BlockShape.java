...
public class BlockShape {
    ...
    public static final float COMMAND_PORT_OFFSET = 16f;
    ...
    public static final float BOTTOM_SOCKET_UPPER_SPACER = 5f;
    ...
    protected int determineBlockWidth() {
        ...
        if (width < rb.accomodateImagesWidth()) {
            width += (rb.accomodateImagesWidth() - width) + 14;
        }
    ...
    protected int determineBlockHeight() {
        ...
        if (heightSum < rb.accomodateImagesHeight()) {
            heightSum += (rb.accomodateImagesHeight() - heightSum) + 12;
        }
