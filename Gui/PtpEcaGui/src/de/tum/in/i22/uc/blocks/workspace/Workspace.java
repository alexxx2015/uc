...
import de.tum.in.i22.uc.blocks.codeblockutil.Explorer;
import de.tum.in.i22.uc.blocks.codeblockutil.ExplorerEvent;
import de.tum.in.i22.uc.blocks.codeblockutil.ExplorerListener;
...
import de.tum.in.i22.uc.blocks.workspace.typeblocking.FocusTraversalManager;
import de.tum.in.i22.uc.blocks.workspace.typeblocking.TypeBlockManager;
...
public class Workspace extends JLayeredPane implements ISupportMemento, RBParent, ChangeListener, ExplorerListener {
    ...
    // the environment wraps all the components of a workspace (Blocks, RenderableBlocks, BlockStubs, BlockGenus)
    ...
    //02 March 2013. My addition. Helps to monitor status of workspace from workspace controller
    private boolean bLoaded=false;
    //03 March 2013
    private WorkspaceWidget wwTrashCan;
    //18 March 2013
    private de.tum.in.i22.uc.policy.classes.Resource entity;
    public Resource getEntityInstance(){
    	return entity;
    }
    public void setEntityInstance(Resource data){
    	entity=data;
    }
    ...
    public Page getCurrentPage(){
    	//return getPageNamed("Turtles");
    	return getPageNamed("Usage Control Policy");    	
    }
    ...
    //03 March 2013
    public WorkspaceWidget getTrashCanWidget(){    	
    	return wwTrashCan;
    }
    
    public void setTrashCanWidget(WorkspaceWidget w){
    	wwTrashCan=w;
    }
}
