...
public abstract class LabelWidget extends JComponent {
    ...
    /** If this is a number, then only allow negatvie signs and periods at certain spots */
    ...
    private class LabelMenu extends JPanel implements MouseListener, MouseMotionListener {
        ...
        private void setSiblings(String[][] siblings) {
            ...
            for (int i = 0; i < siblings.length; i++) {
            	//dont add actioname, param and value "literally"; they are there only to create family
            	if(siblings[i][0].equalsIgnoreCase("actionName")||siblings[i][0].equalsIgnoreCase("paramName")||siblings[i][0].equalsIgnoreCase("paramValue")){}
    			else{
