...
/**
 * Handles change of value of parameter class. Recall every
 * parameter has 4 parts: status (checkbox), name (combo-box),
 * class (combo-box) and value (textbox) 
 * 
 * @author ELIJAH
 */
public class ParamClassChangeCommand implements Command {
	 ...
	 * @param state
	 */
	public ParamClassChangeCommand(PreviousState state){
