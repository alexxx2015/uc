...
public class JComponentDragHandler implements MouseListener, MouseMotionListener {
    ...
    //21-Feb-2013. Changed picture types from .png to .gif, to avoid
    //file path issues during deployment, the null pointer problem
    //I first had on this project.
    private static void initHandCursors() {
    	
        openHandCursor = createHandCursor("/de/tum/in/i22/uc/blocks/codeblocks/open_hand.gif", "openHandCursor");
        closedHandCursor = createHandCursor("/de/tum/in/i22/uc/blocks/codeblocks/closed_hand.gif", "closedHandCursor");        
    }
