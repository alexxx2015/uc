...
/**
 * This is basically the same as the IPIPCommunication interface, but every
 * method has to throw an RemoteException + it implements the Remote Interface.
 */
public interface RMICommunicationInterface extends Remote {
    // / <summary>
    // / Initializes the PIP and its data structures.
    // / </summary>
    // / <returns></returns>
    boolean initializePIP() throws RemoteException;
    ...
    // / <returns></returns>
    int initialRepresentation(int PID, String rep) throws RemoteException;
    ...
    // / <returns></returns>
    int updatePIP(PDPEvent newEvent) throws RemoteException;
    ...
    // / <returns></returns>
    int representationRefinesData(int PID, String rep, int dataID, boolean strict) throws RemoteException;
    ...
    // / <param name="strict"></param>
    // / <returns></returns>
    UniqueIntList getDataIDbyRepresentation(int PID, String rep, boolean strict) throws RemoteException;

    // / <summary>
    // / Resets the status of the PIP.
    // / </summary>
    void resetPIP() throws RemoteException;
