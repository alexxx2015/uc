...
public class GlobalSettings {
	...
	private static Logger _logger = Logger.getLogger(GlobalSettings.class);
	...
	private GlobalSettings(String propertiesFilename) {
	...
	public static GlobalSettings getInstance(String propertiesFilename) {
		if (_instance != null) {
			throw new IllegalStateException("PDP properties have already been initialized and loaded. "
					+ "Only the first invocation of " + GlobalSettings.class + ".getInstance() might be invoked with a parameter.");
		}

		_instance = new GlobalSettings(propertiesFilename);
